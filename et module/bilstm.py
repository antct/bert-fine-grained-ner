...
class BiLSTM(nn.Module):
    def __init__(self, input_size, hidden_size, num_layers, dropout, num_dirs):
        super().__init__()
    ...
    def forward(self, x, mask, pack=True):
        ...
        if pack:
            ...
            padded_out, _ = nn.utils.rnn.pad_packed_sequence(out, batch_first=True, total_length=args.bert_max_len)
            #padded_out, _ = nn.utils.rnn.pad_packed_sequence(out, batch_first=True)
